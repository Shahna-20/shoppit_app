...
const PaymentStatusPage = ({setNumberCartItems}) => {
  ...
  return (
    <header className='py-5' style={{backgroundColor:"#001F3F"}}>
    <div className='container px-4 px-lg-5 my-5'>
        <div className='text-center text-white'>
            <h2 className='dispaly-4 fw-bold'>{statusMessage}</h2>
            <p className='lead fw-normal text-white-75 mb-4'>{statusSubMessage}</p>
            <span>
                <Link to="/profile" className='btn btn-light btn-lg px-4 py-2 mx-3'>View Order Deatils</Link>
